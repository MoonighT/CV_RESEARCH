...
int main(int argc, char** argv)
{
    ...
    //MView->addPointCloud (keypoints_tgt, white, "target_key", v1); 
    ...
    // pfh_est_src.setSearchSurface (cloud_src);   
    ...
    // pfh_est_tgt.setSearchSurface (cloud_tgt);   
    ...
    fpfh_est_src.setInputCloud (cloud_src); //<------------- But only compute features at the key-points 
    ...
    fpfh_est_tgt.setInputCloud (cloud_tgt); 
